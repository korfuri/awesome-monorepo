...
* [Fynpo](https://www.electrode.io/fynpo/) is a JavaScript monorepo manager with some different approaches that solve the usual downsides of a monorepo workspace.
